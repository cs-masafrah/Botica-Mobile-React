...
const ServicesContentTheme: React.FC<ServicesContentThemeProps> = ({
  theme,
}) => {
    ...
    <View style={[styles.container, isRTL && styles.containerRTL]}>
      ...
      <View style={[styles.servicesGrid, isRTL && styles.servicesGridRTL]}>
        {services.map((service: ThemeService, index: number) => (
          <View
            key={index}
            style={[styles.serviceItem, isRTL && styles.serviceItemRTL]}
          >
            <View
            ...
            <View style={[styles.serviceText, isRTL && styles.serviceTextRTL]}>
              <Text
                style={[styles.serviceTitle, isRTL && styles.serviceTitleRTL]}
              >
                {service.title}
              </Text>
              <Text
